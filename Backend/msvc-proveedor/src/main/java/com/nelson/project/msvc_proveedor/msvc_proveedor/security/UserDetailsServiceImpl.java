...
import com.nelson.project.msvc_proveedor.msvc_proveedor.clientfeign.UsuarioFeignClient;
  ...
  public UserDetails loadUserByUsername(String username)
    ...
    try {
      ...
      if (usuario == null || !usuario.isActive()) {
        logger.warn(
          "[UserDetailsServiceImpl] Usuario no encontrado o inactivo: {}",
          username
        );
      ...
      logger.error(
        "[UserDetailsServiceImpl] Error consultando usuario: {}",
        username,
        e
      );
      throw new UsernameNotFoundException(
